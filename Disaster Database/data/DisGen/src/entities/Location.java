...
/**
 * This class is used to create location objects. They will be used to add
 * locations to disasters.
 * 
...
public class Location {
	...
	public Location(String city, String country, int population, double minLatitude, double maxLatitude, double minLongitude, double maxLongitude) {
		
		// call other constructor 
		this(city, country, population);
